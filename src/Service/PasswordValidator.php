    ...
    public static function validate(
        ...
        */
        ...
        if (!preg_match('/[^a-zA-Z0-9]/u', $password)) {
            $errors[] = 'Ajoutez au moins un caractère spécial.';
        }
        ...
        */
        ...
        if ($email) {
            $needles[] = explode('@', mb_strtolower($email))[0] ?? '';
        }

        if ($firstname) {
            $needles[] = mb_strtolower($firstname);
        }

        if ($lastname) {
            $needles[] = mb_strtolower($lastname);
        }
        ...
        /*
        |----------------------------------------
        | 7) Interdire le même mot de passe
        |----------------------------------------
        */
